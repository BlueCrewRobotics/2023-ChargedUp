...
void RobotContainer::ConfigureBindings() {
  ...
  driverController_button_x->WhenPressed(CmdFindAndGoToCube(&m_subDriveTrain, &m_subLimeLightLower, driverController));
  driverController_button_y->WhenPressed(CmdFindAndGoToCone(&m_subDriveTrain, &m_subLimeLightLower, driverController));

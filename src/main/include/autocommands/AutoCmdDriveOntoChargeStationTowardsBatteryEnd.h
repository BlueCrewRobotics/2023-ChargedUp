 ...
 */
class AutoCmdDriveOntoChargeStationTowardsBatteryEnd
    : public frc2::CommandHelper<frc2::CommandBase, AutoCmdDriveOntoChargeStationTowardsBatteryEnd> {
 public:
  AutoCmdDriveOntoChargeStationTowardsBatteryEnd(SubDriveTrain* subDriveTrain);

 ...
 */
class AutoCmdBalanceOnChargeStation
    : public frc2::CommandHelper<frc2::CommandBase, AutoCmdBalanceOnChargeStation> {
 public:
  AutoCmdBalanceOnChargeStation(SubDriveTrain* subDriveTrain);

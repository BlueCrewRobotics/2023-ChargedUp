...
class SubLimeLightBase : public frc2::SubsystemBase {
 public:
  SubLimeLightBase();
  ...
  void Periodic() override;
    ...
    /**
     Get whether or not LimeLightBase has a target
    */
  bool GetTarget();
 ...
 */
  ...
  double GetDistanceToTarget(double h1_heightOfCamera, double h2_heightOfCenterTarget, double a1_angleOfCamera);
  ...
  */
   ...
   */
  double GetLimeLightBaseDistance();

  /** Set the LimeLightBase distance value
   * 
   * @param distance the distance to the target
   */
  void SetLimeLightBaseDistance(double distance);

 protected:
  // Components (e.g. motor controllers and sensors) should generally be
  // declared private and exposed only through public methods.

  std::shared_ptr<nt::NetworkTable> tblLimeLight;
